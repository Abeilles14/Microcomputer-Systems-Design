; C:\IDE68K\ASS2_PARTB\M68KDEBUG.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
...
; // add your code to test memory here using 32 bit reads and writes of data between the start and end of memory
; // prompt user for data pattern
; while (1) {
MemoryTest_1:
; printf("Enter one of the following characters to create a test data pattern to write [5, A, F, 0]: \n");
       pea       @m68kde~1_144.L
       jsr       (A2)
       addq.w    #4,A7
; c = _getch();
...
; }
; }
; // prompt user for data size
; while (1) {
MemoryTest_12:
; printf("Enter [1] for Bytes, [2] for Words, or [3] for Long Words\n");
       pea       @m68kde~1_147.L
       jsr       (A2)
       addq.w    #4,A7
; c = _getch();
...
MemoryTest_15:
; }
; else if (c == (char)('2')) {    // 2 bytes (16 bits)
       cmp.b     #50,D3
       bne.s     MemoryTest_17
; data = pattern | pattern << 8;
       move.l    D2,D0
       move.l    D2,D1
       lsl.l     #8,D1
       or.l      D1,D0
...
MemoryTest_17:
; }
; else if (c == (char)('3')) {    // 4 bytes (32 bites)
       cmp.b     #51,D3
       bne       MemoryTest_19
; data = pattern | pattern << 8 | pattern << 16 | pattern << 24;
       move.l    D2,D0
       move.l    D2,D1
       lsl.l     #8,D1
       or.l      D1,D0
...
; }
; }
; // prompt user for a start and end address for the test
; while (1) {
MemoryTest_21:
; printf("Enter a 4 byte start address for the test (eg. 09000000).\n");
       pea       @m68kde~1_152.L
       jsr       (A2)
       addq.w    #4,A7
; printf("Note 1: Addresses should align to an even address.\n");
       pea       @m68kde~1_153.L
       jsr       (A2)
       addq.w    #4,A7
; printf("Note 2: Addresses should be in range 0x09000000 - 0x097FFFFF.\n");
       pea       @m68kde~1_154.L
       jsr       (A2)
       addq.w    #4,A7
; Start = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D7
; //start_addr = (int)strtol(hexstring, NULL, 0);
; //if (Start >= 0x08020000 && Start <= 0x08030000) {
; if (Start >= 0x09000000 && Start <= 0x097FFFFF) {
       cmp.l     #150994944,D7
       blo.s     MemoryTest_24
       cmp.l     #159383551,D7
       bhi.s     MemoryTest_24
...
; End = Get8HexDigits(0);
       ...
       move.l    D0,D6
; //start_addr = (int)strtol(hexstring, NULL, 0);
; //if (End >= 0x08020000 && End <= 0x08030000 && End >= Start) {
; if (End >= 0x09000000 && End <= 0x097FFFFF && End >= Start) {
       cmp.l     #150994944,D6
       blo       MemoryTest_31
       cmp.l     #159383551,D6
       bhi.s     MemoryTest_31
...
; char *BugMessage = "DE1-68k Bug V1.77";
       lea       @m68kde~1_163.L,A0
       move.l    A0,D3
; char *CopyrightMessage = "Copyright (C) PJ Davies 2016";
       lea       @m68kde~1_164.L,A0
       move.l    A0,-8(A6)
; char* LabMessage = "Name: Isabelle Andre - Stu#: 12521589";
...
@m68kde~1_143:
       ...
       dc.b      41,32,58,0
@m68kde~1_144:
       dc.b      69,110,116,101,114,32,111,110,101,32,111,102
       dc.b      32,116,104,101,32,102,111,108,108,111,119,105
       dc.b      110,103,32,99,104,97,114,97,99,116,101,114,115
       dc.b      32,116,111,32,99,114,101,97,116,101,32,97,32
       dc.b      116,101,115,116,32,100,97,116,97,32,112,97,116
       dc.b      116,101,114,110,32,116,111,32,119,114,105,116
       dc.b      101,32,91,53,44,32,65,44,32,70,44,32,48,93,58
       dc.b      32,10,0
@m68kde~1_145:
       dc.b      13,10,80,97,116,116,101,114,110,58,32,48,120
       dc.b      37,120,32,115,101,108,101,99,116,101,100,10
       dc.b      0
@m68kde~1_146:
       dc.b      13,10,80,97,116,116,101,114,110,32,73,110,118
       dc.b      97,108,105,100,46,10,0
@m68kde~1_147:
       dc.b      69,110,116,101,114,32,91,49,93,32,102,111,114
       dc.b      32,66,121,116,101,115,44,32,91,50,93,32,102
       dc.b      111,114,32,87,111,114,100,115,44,32,111,114
       dc.b      32,91,51,93,32,102,111,114,32,76,111,110,103
       dc.b      32,87,111,114,100,115,10,0
@m68kde~1_148:
       dc.b      13,10,66,121,116,101,32,115,101,108,101,99,116
       dc.b      101,100,58,32,48,120,37,120,10,0
@m68kde~1_149:
       dc.b      13,10,87,111,114,100,32,115,101,108,101,99,116
       dc.b      101,100,58,32,48,120,37,120,10,0
@m68kde~1_150:
       dc.b      13,10,76,111,110,103,32,87,111,114,100,32,115
       dc.b      101,108,101,99,116,101,100,58,32,48,120,37,120
       dc.b      10,0
@m68kde~1_151:
       dc.b      13,10,73,110,118,97,108,105,100,32,100,97,116
       dc.b      97,32,115,105,122,101,46,10,0
@m68kde~1_152:
       dc.b      69,110,116,101,114,32,97,32,52,32,98,121,116
       dc.b      101,32,115,116,97,114,116,32,97,100,100,114
       dc.b      101,115,115,32,102,111,114,32,116,104,101,32
       dc.b      116,101,115,116,32,40,101,103,46,32,48,57,48
       dc.b      48,48,48,48,48,41,46,10,0
@m68kde~1_153:
       dc.b      78,111,116,101,32,49,58,32,65,100,100,114,101
       dc.b      115,115,101,115,32,115,104,111,117,108,100,32
       dc.b      97,108,105,103,110,32,116,111,32,97,110,32,101
       dc.b      118,101,110,32,97,100,100,114,101,115,115,46
       dc.b      10,0
@m68kde~1_154:
       dc.b      78,111,116,101,32,50,58,32,65,100,100,114,101
       dc.b      115,115,101,115,32,115,104,111,117,108,100,32
       dc.b      98,101,32,105,110,32,114,97,110,103,101,32,48
       dc.b      120,48,57,48,48,48,48,48,48,32,45,32,48,120
       dc.b      48,57,55,70,70,70,70,70,46,10,0
@m68kde~1_155:
       dc.b      13,10,83,116,97,114,116,32,97,100,100,114,101
       dc.b      115,115,32,110,111,116,32,101,118,101,110,46
       dc.b      10,0
@m68kde~1_156:
       dc.b      13,10,83,116,97,114,116,32,97,100,100,114,101
       dc.b      115,115,32,110,111,116,32,119,105,116,104,105
       dc.b      110,32,114,97,110,103,101,46,10,0
@m68kde~1_157:
       dc.b      13,10,69,110,116,101,114,32,97,32,52,32,98,121
       dc.b      116,101,32,101,110,100,32,97,100,100,114,101
       dc.b      115,115,32,102,111,114,32,116,104,101,32,116
       dc.b      101,115,116,32,40,101,103,46,32,48,57,55,70
       dc.b      70,70,70,70,41,46,10,0
@m68kde~1_158:
       dc.b      13,10,69,110,100,32,97,100,100,114,101,115,115
       dc.b      32,110,111,116,32,101,118,101,110,46,10,0
@m68kde~1_159:
       dc.b      13,10,69,110,100,32,97,100,100,114,101,115,115
       dc.b      32,110,111,116,32,119,105,116,104,105,110,32
       dc.b      114,97,110,103,101,32,111,114,32,98,101,102
       dc.b      111,114,101,32,83,116,97,114,116,32,97,100,100
       dc.b      114,101,115,115,46,10,0
@m68kde~1_160:
       dc.b      13,10,87,114,105,116,105,110,103,32,99,111,109
       dc.b      112,108,101,116,101,46,10,0
@m68kde~1_161:
       dc.b      13,10,82,101,97,100,32,68,97,116,97,32,105,110
       dc.b      32,65,100,100,114,101,115,115,32,82,97,110,103
       dc.b      101,32,77,97,116,99,104,101,115,32,87,114,105
       dc.b      116,116,101,110,32,68,97,116,97,32,80,97,116
       dc.b      116,101,114,110,32,45,32,77,101,109,111,114
       dc.b      121,32,84,101,115,116,32,83,117,99,99,101,115
       dc.b      115,102,117,108,33,10,0
@m68kde~1_162:
       dc.b      13,10,77,101,109,111,114,121,32,84,101,115,116
       dc.b      32,100,97,116,97,32,109,105,115,45,109,97,116
       dc.b      99,104,44,32,101,110,100,105,110,103,32,116
...
@m68kde~1_164:
       ...
       dc.b      49,54,0
@m68kde~1_165:
       dc.b      78,97,109,101,58,32,73,115,97,98,101,108,108
       dc.b      101,32,65,110,100,114,101,32,45,32,83,116,117
       dc.b      35,58,32,49,50,53,50,49,53,56,57,0
@m68kde~1_166:
