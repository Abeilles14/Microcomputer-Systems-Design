...
void MemoryTest(void)
{
    ...
    while (1) {
        printf("Enter a 4 byte start address for the test (eg. 08020000).\n");
        printf("Note 1: Addresses should align to an even address.\n");
        printf("Note 2: Addresses should be in range 0x08020000 - 0x08030000.\n");
    ...
    while (1) {
        printf("\r\nEnter a 4 byte end address for the test (eg. 08030000).\n");
        printf("Note 1: Addresses should align to an even address.\n");
        printf("Note 2: Addresses should be in range 0x08020000 - 0x08030000.\n");
